 ...
 */
@Embeddable
public class LogCardStatePK implements Serializable {
    ...
    public LogCardStatePK() {
    }

    public LogCardStatePK(String idCard, Date datetime) {
        this.idCard = idCard;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LogCardStatePK)) {
            return false;
        }
        LogCardStatePK other = (LogCardStatePK) object;
    ...
    public String toString() {
        return "com.cligest.timesheet.domain.LogCardStatePK[ idCard=" + idCard + ", datetime=" + datetime + " ]";
    }
